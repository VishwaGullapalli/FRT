...
//                             </div>
//                         </div>
//                         <div className="mx-auto max-w-screen-sm text-sm text-left text-gray-500 newsletter-form-footer dark:text-gray-300">We care about the protection of your data. <Link to="/privacy" className="font-medium text-primary-600 dark:text-primary-500 hover:underline">Read our Privacy Policy</Link>.</div>
//                     </form>
//                 </div>
//             </div>
//         </section>
...
const NewsLetter: React.FC = () => {
    ...
    const handleSubscribe = () => {
        ...
        const body = 'Subscribe for Updates';
